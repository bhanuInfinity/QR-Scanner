...
//        mServiceHandler = new Handler(handlerThread.getLooper());
    ...
    private Notification getNotification() {
        ...
        CharSequence text = Utils.INTANCE.getLocationText(mLocation);
    ...
    public void removeLocationUpdates() {
        ...
        try {
            ...
            //Utils.INTANCE.setRequestingLocationUpdates(this, false);
            stopSelf();
        } catch (SecurityException unlikely) {
           // Utils.INTANCE.setRequestingLocationUpdates(this, true);
